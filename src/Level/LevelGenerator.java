...
public class LevelGenerator {
	...
	//wenn eine ein Gegenstand mit einer h�hren Wahrscheinlichkeit plaziert werden soll, muss dieser �fter in den Pool hinzugefuegt werden.
	...
	//wenn eine ein Monster mit einer h�hren Wahrscheinlichkeit plaziert werden soll, muss dieser �fter in den Pool hinzugefuegt werden.
	...
	private void raeumeGenerieren() {
		...
		// erstellt die groe�e des Raumes anhand des zufaelligen Wertes von 'max'
	 ...
	 * @return den neuen Raum der f�r den Algorithmus gebraucht wird.
	 */
